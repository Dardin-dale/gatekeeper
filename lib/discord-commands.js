            ...
            options: [
              {
                ...
                required: true,
                choices: [
                  { name: 'Server online / ready', value: 'online' },
                  { name: 'Idle-shutdown notice', value: 'idle' },
                  { name: 'Backup complete', value: 'backup' },
                  { name: 'Failed to start', value: 'failed' },
                  { name: 'In-game events (deaths, raids)', value: 'events' },
                ],
              },
              {
                type: STRING,
